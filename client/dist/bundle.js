...
/*Criando módulo para que as propriedadesos 
    ...
    adiciona(negociacao) {
        return new Promise((resolve, reject) => {
            ...
            request.onerror = e => {
                ...
                reject('Não foi possível salvar a negociacao');
            };
        });
    }
...
let DateConverter = class DateConverter {
    ...
    static paraData(texto) {
        ...
        if (!/\d{2}\/\d{2}\/\d{4}/.test(texto)) throw new __WEBPACK_IMPORTED_MODULE_0__DataInvalidaException_js__["a" /* DataInvalidaException */]('Deve estar no formato dd/mm/aaaa');
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_bootstrap_dist_css_bootstrap_css__ = __webpack_require__(11);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_bootstrap_dist_css_bootstrap_theme_css__ = __webpack_require__(12);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__css_meucss_css__ = __webpack_require__(13);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__controllers_NegociacaoController_js__ = __webpack_require__(14);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__domain_negociacao_Negociacao_js__ = __webpack_require__(0);
...
const negociacao = new __WEBPACK_IMPORTED_MODULE_4__domain_negociacao_Negociacao_js__["a" /* Negociacao */](new Date(), 1, 350);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__domain_index_js__ = __webpack_require__(15);
...
let NegociacaoController = (_dec = __WEBPACK_IMPORTED_MODULE_2__util_index_js__["c" /* controller */]('#data', '#quantidade', '#valor'), _dec2 = __WEBPACK_IMPORTED_MODULE_2__util_index_js__["b" /* bindEvent */]('submit', '.form'), _dec3 = __WEBPACK_IMPORTED_MODULE_2__util_index_js__["d" /* debounce */](), _dec4 = __WEBPACK_IMPORTED_MODULE_2__util_index_js__["b" /* bindEvent */]('click', '#botao-apaga'), _dec5 = __WEBPACK_IMPORTED_MODULE_2__util_index_js__["b" /* bindEvent */]('click', '#botao-importa'), _dec6 = __WEBPACK_IMPORTED_MODULE_2__util_index_js__["d" /* debounce */](1550), _dec(_class = (_class2 = class NegociacaoController {
    ...
    constructor(inputData, inputQuantidade, inputValor) {
        ...
        this._negociacoes = new __WEBPACK_IMPORTED_MODULE_2__util_index_js__["a" /* Bind */](new __WEBPACK_IMPORTED_MODULE_0__domain_index_js__["c" /* Negociacoes */](), new __WEBPACK_IMPORTED_MODULE_1__ui_index_js__["e" /* NegociacoesView */]('#negociacoes'), 'adiciona', 'esvazia');
    ...
    adiciona(event) {
        ...
        return _asyncToGenerator(function* () {
            try {
                ...
                _this2._mensagem.texto = 'Negociacao adicionada com sucesso';

                _this2._limparFormulario();
            } catch (err) {
                if (err instanceof __WEBPACK_IMPORTED_MODULE_1__ui_index_js__["a" /* DataInvalidaException */]) {
                    _this2._mensagem.texto = err.message;
                } else {
                    _this2.message.texto = 'Um erro não esperado aconteceu. Entre em contato com o suporte';
                }
            }
        })();
    }
    ...
    _criarNegociacao() {
        return new __WEBPACK_IMPORTED_MODULE_0__domain_index_js__["a" /* Negociacao */](__WEBPACK_IMPORTED_MODULE_1__ui_index_js__["b" /* DateConverter */].paraData(this._inputData.value), parseInt(this._inputQuantidade.value), parseFloat(this._inputValor.value));
    }
    ...
    obtemNegociacoesDoPeriodo() {
        ...
        return _asyncToGenerator(function* () {
            try {
                ...
                console.log(err);
                throw new __WEBPACK_IMPORTED_MODULE_2__util_ApplicationException_js__["a" /* ApplicationException */]().getExceptionMessage(err);
            };
        })();
    }
};
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__views_View_js__ = __webpack_require__(3);
/* unused harmony namespace reexport */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__views_MensagemView_js__ = __webpack_require__(25);
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "d", function() { return __WEBPACK_IMPORTED_MODULE_1__views_MensagemView_js__["a"]; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__views_NegociacoesView_js__ = __webpack_require__(26);
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "e", function() { return __WEBPACK_IMPORTED_MODULE_2__views_NegociacoesView_js__["a"]; });
